# Case: descripción del caso desarrollado incluyendo los diseños de base de datos y diccionario de datos
...
#Script: scripts funcionales tanto de estructuras como de gestión de datos.
SCRIPT:
